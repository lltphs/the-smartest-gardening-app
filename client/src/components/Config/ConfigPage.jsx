...
class ConfigPage extends Component {
    ...
    async componentWillMount(){
        await fetch('/gettheshold', {
          ...
          data.json().then(db =>{
            this.setState({areaID: db[0]['areaID'], sensor: db[0]['sensor']})
          })
        })
      }
    ...
    render(){
        ...
        return (
            ...
            <AreaConsumer>
                {value => {
                    const {_areaID, _sensor } ={_areaID: this.state.areaID, _sensor: this.state.sensor };
                                    ...
                                    <div className='threshold_amount_water'>
                                            ...
                                            <div className='_inputThresholdAmount'>
                                                <input 
                                                    ...
                                                    name = 'threshold'
                                                    defaultValue= {_sensor.threshold}
                                                    onChange={this.handleChange}
                                                />
